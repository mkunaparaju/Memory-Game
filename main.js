...
for (var i = 0; i < 8; i++) { 
 // var randNum = Math.random();
  //var randImg = Math.floor(randNum*100 /10);
  //var rand = Math.floor(Math.random() * (1200 - 900 + 1) + 900); 
  //console.log(randImg);
  var img = 'images/image' + i + '.jpg';
  images.push(img);
  images.push(img);
}
randomizeImages();
...
$("li").click(function() {
  if ((count < 2) &&  ($(this).children("img").hasClass("face-up")) === false) {
    ...
    //guess #2
     ...
     document.getElementById("count").innerHTML = "The number of trials it took for you to win is: " + countmm;
      // reset
      count = 0; 
